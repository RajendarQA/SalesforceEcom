...
${Comments_txt}    Test Comment
${purchase_order_no}    //input[@name="po-number"]
${place_order_btn}    //button[normalize-space()='Place Order']
${place_order_confirmation}    //p[@class='order-confirmation-number' and contains(text(), "PO Number: ")]
...
Enter The Account Information
    ...
    Input Text    ${order_comments}    ${Comments_txt}
    Wait Until Element Is Visible    ${Proceed_btn}    180
    Highlight_Border    ${Proceed_btn}
    Click Element    ${Proceed_btn}
...
Random_PO_Number
    ...
    ${gen_po_num}=    Set Variable    PO-${random_num}
    RETURN    ${gen_po_num}
